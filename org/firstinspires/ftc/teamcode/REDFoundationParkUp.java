...
@Autonomous(name = "REDFoundationParkUp", group = "")
public class REDFoundationParkUp extends LinearOpMode {
    ...
    if (opModeIsActive()) {
      ...
      Encoder_Function(RIGHT, 1000, 0.4);
      Encoder_Function(BACKWARD, 600, 0.4);
      Encoder_Function(RIGHT, 350, 0.4);
