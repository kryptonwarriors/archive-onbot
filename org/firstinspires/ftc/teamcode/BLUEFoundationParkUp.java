...
@Autonomous(name = "BLUEFoundationParkUp", group = "")
public class BLUEFoundationParkUp extends LinearOpMode {
    ...
    if (opModeIsActive()) {
      ...
      Encoder_Function(RIGHT, 200, 0.3);
