...
@Autonomous(name = "RahulPractice (Blocks to Java)", group = "")
public class RahulPractice extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      //Move Robot in a square using encoders and then go straight 
      
      Encoder_Function(FORWARD, 1000);
      Encoder_Function(LEFT, 500);
      Encoder_Function(BACKWARD, 1000);
      Encoder_Function(RIGHT, 500);
  ...
  private void Encoder_Function(int Direction, int TargetPosition) 
  {
    int FORWARD = 0;
    int BACKWARD = 1;
    int LEFT = 2;
